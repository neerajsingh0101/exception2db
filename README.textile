...
I love hoptoad and I esepecially like the ability to catch an exception in a rake task and to send that exception info to hoptoad using hoptoad_notifier. 

Currently I am working on a government project and hoptoad can not be used.  Rather than writing code that captures all the information about exception, I am letting hoptoad_notifier to do all the heavy lifting.
